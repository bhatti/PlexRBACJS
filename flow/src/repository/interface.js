...
/**
 * AuditRecordRepository defines methods for storing audit-records
 */
export interface AuditRecordRepository extends Repository<IAuditRecord> {
    /**
     * This method finds object by id
     * @param {*} id - database id
     */
    findById(id: number): Promise<IAuditRecord>;

    /**
     * This method saves object and returns updated object
     * @param {*} audit-record - to save
     */
    save(record: IAuditRecord): Promise<IAuditRecord>;
}
 ...
 * AuditRecordRepository defines methods for storing audit-records
 */
export interface LimitRepository extends Repository<ILimit> {
    /**
     * This method increments usage count object and returns updated object
     * @param {*} audit-record - to save
     */
    increment(id: number): Promise<?ILimit>;

    /**
     * This method save claims for principal
     */
    __savePrincipalLimits(principal: IPrincipal): Promise<IPrincipal>;

    /**
     * This method loads claims for given principal using claims associated with role and principal
     */
    __loadPrincipalLimits(principal: IPrincipal): Promise<IPrincipal>;
}
