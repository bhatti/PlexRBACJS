...
describe('SecurityManager', function() {
	...
	before(async function() {
		...
		return this.repositoryLocator.roleRepository.save(this.loanOfficer);
	});
	...
	describe('#check', function() {
		it('Loan-officer should be able to read loan account with higher balance', async function() {
	...
	describe('#check', function() {
		it('Loan-officer should be able to create loan account within balance', async function() {
			let larry     = new Principal(this.realm, 'larry');
			larry.claims.add(new Claim(this.realm, '(create|delete)', 'LoanAccount', ''));
			larry.claims.add(new Claim(this.realm, '(read|modify)', 'LoanAccount', ''));
			larry.roles.add(this.loanOfficer);
